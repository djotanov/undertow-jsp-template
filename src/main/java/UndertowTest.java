...
public class UndertowTest {
    public static void main(String[] args) throws Exception {
        ...
        HashMap<String, TagLibraryInfo> taglibs = createTldInfos();
        JspServletBuilder.setupDeployment(deploymentInfo, new HashMap<String, JspPropertyGroup>(), taglibs, new HackInstanceManager());
        ...
        manager.deploy();
        PathHandler path = Handlers.path(Handlers.redirect("/test"))
    ...
    private static HashMap<String, TagLibraryInfo> createTldInfos() throws IOException {
